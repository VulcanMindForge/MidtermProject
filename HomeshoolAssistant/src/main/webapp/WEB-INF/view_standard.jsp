...
<div class="container">
	<div class="bg-image text-center rounded-3 mt-2 d-flex justify-content-center align-items-center h-100">
		<div class="text-white form align-middle w-75">
			<h4>School Year: ${standard.standardYear }<br> 
				State: ${standard.state } <br>
				<a target="_blank" href="${standard.url}">Link to State Standard</a> <br> 
				...
				<c:forEach var="resource" items="${standard.resources}">
					Resources that use this Standard: <a href="viewResource.do?resourceId=${resource.id}">${resource.title}</a> <br>
				</c:forEach>
			</h4>
